...
class FillPermissionsForOperacion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOperacion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.operacion',
            'admin.operacion.index',
            'admin.operacion.create',
            'admin.operacion.show',
            'admin.operacion.edit',
            'admin.operacion.delete',
            'admin.operacion.bulk-delete',
        ]);
